...
//        this.mLicenseProvider = mLicenseProvider;
   ...
   public int init(){
        ...
        int ret = mRenderManager.init(mContext, mResourceProvider.getModelPath(), filePath, USE_PIPELINE,
                mLicenseProvider.getLicenseMode() == EffectLicenseProvider.LICENSE_MODE_ENUM.ONLINE_LICENSE,renderapi);
...
//       setUseBuiltinSensor(true);
     ...
     * @param only RGBA supported rotation
