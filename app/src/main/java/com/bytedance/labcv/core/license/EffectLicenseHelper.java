...
public class EffectLicenseHelper implements EffectLicenseProvider {
    ...
    public String getLicensePath() {
        ...
        _errorMsg = "";
        //同步请求
        int retCode = licenseWrapper.getLicenseWithParams(new HashMap<String, String>(), false, new com.bytedance.labcv.licenselibrary.LicenseCallback() {
            @Override
    ...
    public String updateLicensePath() {
        _errorCode = 0;
        //同步请求
        int retCode = licenseWrapper.updateLicenseWithParams(new HashMap<String, String>(), false, new com.bytedance.labcv.licenselibrary.LicenseCallback() {
            @Override
            public void execute(String retmsg, int retSize, int errorCode, String errorMsg) {
                _errorCode = errorCode;
                _errorMsg = errorMsg;
